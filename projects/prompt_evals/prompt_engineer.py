...
if __name__ == "__main__":
    ...
    dataset = evaluator.generate_dataset(
        ...
        output_file=str(docs_dir / "dataset.json"),
        num_cases=3,
    )

    evaluator.run_evaluation(
        run_prompt_function=run_prompt,
        dataset_file=str(docs_dir / "dataset.json"),
        extra_criteria="""
        ...
        """,
        json_output_file=str(docs_dir / "output.json"),
        html_output_file=str(docs_dir / "output.html"),
    )